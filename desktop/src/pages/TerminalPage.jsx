...
export default function TerminalPage({ client, config }) {
  ...
  useEffect(() => {
    ...
    term.writeln('\x1b[90m  opkg install rpcd-mod-file luci-mod-rpc\x1b[0m')
    term.writeln('\x1b[90m  cat > /usr/share/rpcd/acl.d/owm.json << \'EOF\'\x1b[0m')
    term.writeln('\x1b[90m  {\x1b[0m')
    term.writeln('\x1b[90m    "root": {\x1b[0m')
    term.writeln('\x1b[90m      "read": {\x1b[0m')
    term.writeln('\x1b[90m        "ubus": {"*": ["*"]},\x1b[0m')
    term.writeln('\x1b[90m        "uci":  {"*": ["read"]},\x1b[0m')
    term.writeln('\x1b[90m        "file": {"*": ["read","exec","list"]}\x1b[0m')
    term.writeln('\x1b[90m      },\x1b[0m')
    term.writeln('\x1b[90m      "write": {\x1b[0m')
    term.writeln('\x1b[90m        "ubus": {"*": ["*"]},\x1b[0m')
    term.writeln('\x1b[90m        "uci":  {"*": ["read","write"]},\x1b[0m')
    term.writeln('\x1b[90m        "file": {"*": ["read","write","exec","list"]}\x1b[0m')
    term.writeln('\x1b[90m      }\x1b[0m')
    term.writeln('\x1b[90m    }\x1b[0m')
    term.writeln('\x1b[90m  }\x1b[0m')
    term.writeln('\x1b[90m  EOF\x1b[0m')
